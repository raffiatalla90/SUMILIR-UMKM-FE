...
<template>
  <div class="flex flex-col min-h-screen pb-16 sm:pb-0">
    ...
    <div
      class="hidden sm:block sticky top-0 z-50 w-full h-[72px] bg-white border-b border-gray-200 shadow-sm"
    >
    ...
    >
      <div
        v-if="showSearch"
        class="hidden sm:block bg-white border-b border-gray-200 shadow-sm fixed top-[72px] left-0 right-0 z-[1002]"
      >
